...
Dyn can provide a very simple solution for fail over. When you have a network outage in your primary Data Center you want to fail over as soon as possible.
...
This way you save the time it takes for new instances to start serving at your Auto Scale Group and they will be ready and waiting for traffic to arrive.

I run python script in a zabbix-proxy server (at AWS)
...
There are 2 cfg files that the scripts checks before launching instances:

~~~
/root/service1.cfg
/root/service2.cfg
~~~
Both files contain a string “Error/OK”
...
After DR complete You need to manually restore the strings in the cfg files to: “OK” for the script to work again.
...
run()
~~~
> Dyn allows you to migrate your traffic automatically. combined with AWS Auto Scaling, you have an Automatic DR function.
